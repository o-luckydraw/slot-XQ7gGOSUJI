            ...
            {isUnavailable ? (
              ...
              <>
                ...
                <button
                  ...
                  className="btn-img w-full h-10 bg-primary text-primary-text rounded-btn font-bold text-sm shadow-sm hover:opacity-90 active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed tracking-wide"
                >
